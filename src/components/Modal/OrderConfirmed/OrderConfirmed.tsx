...
const OrderConfirmed: FC = () => {
    ...
    return (
        <div className={`${styles.OrderDetails} pt-30 pb-30`}>
            ...
            <section className={`${styles.Done} mt-15 mb-15`}>
                <svg width="107" height="102" viewBox="0 0 107 102" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="url(#paint0_radial_2196_3723)"
                        fillOpacity="0.25"
                    />
                    <path
                        fillRule="evenodd"
                        ...
                        fill="url(#paint1_radial_2196_3723)"
                        fillOpacity="0.25"
                    />
                    <path
                        fillRule="evenodd"
                        ...
                        fill="url(#paint2_radial_2196_3723)"
                        fillOpacity="0.25"
                    />
                    <path
                        fillRule="evenodd"
                    ...
                    />
                    <defs>
                        <radialGradient id="paint0_radial_2196_3723" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(53 51) rotate(-46.1458) scale(70.7248 53.2019)">
                            <stop stopColor="#801AB3" stopOpacity="0" />
                            <stop offset="1" stopColor="#4C4CFF" />
                        </radialGradient>
                        <radialGradient id="paint1_radial_2196_3723" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(53.5 51) rotate(-43.0632) scale(73.2274 55.0025)">
                            <stop stopColor="#801AB3" stopOpacity="0" />
                            <stop offset="1" stopColor="#4C4CFF" />
                        </radialGradient>
                        <radialGradient id="paint2_radial_2196_3723" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(53 50.6667) rotate(136.146) scale(47.1499 35.4679)">
                            <stop stopColor="#801AB3" stopOpacity="0" />
...
export default memo(OrderConfirmed);